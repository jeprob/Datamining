...
if __name__ in "__main__":
   ...
   # font size in plots:
    ...
    [X_imputed, r, testing_errors] = svd_imputation_optimised(X=X_missing, ranks=ranks, test_size=0.3)
    ...
    plt.vlines(x=r, colors ='red', ymin=0, ymax=max(testing_errors))
    plt.xlabel("Ranks")
    plt.title('Mean squared errors corresponding to rank r approximation')
